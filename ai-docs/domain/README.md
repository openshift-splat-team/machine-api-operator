# machine-api-operator Domain Models
...
This directory documents the domain models, custom resource definitions (CRDs), and core data structures used in machine-api-operator.
...
- [Development Guide](../machine-api-operator_DEVELOPMENT.md) - Adding new fields
