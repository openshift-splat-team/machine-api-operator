# machine-api-operator Development Guide
...
This guide covers the development workflow for machine-api-operator.
...
```bash
git clone https://github.com/openshift-splat-team/machine-api-operator.git
...
# Or directly
go build -o bin/machine-api-operator ./cmd/...
```
...
# Or with podman
podman build -t machine-api-operator:latest .
```
...
# Or via command line
./bin/machine-api-operator --log-level=debug
```
...
# Debug
dlv debug ./cmd/machine-api-operator
```
...
- [Testing Guide](machine-api-operator_TESTING.md) - Test suites and strategies
