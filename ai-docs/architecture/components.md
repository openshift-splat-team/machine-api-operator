# machine-api-operator Components
...
This document describes the major components and architecture of machine-api-operator.
...
- [Development Guide](../machine-api-operator_DEVELOPMENT.md) - How to build and run
- [Testing Guide](../machine-api-operator_TESTING.md) - How to test components
