# machine-api-operator Testing Guide
...
This guide covers all test suites for machine-api-operator and how to run them.
...
- `pull-ci-machine-api-operator-unit` - Unit tests
- `pull-ci-machine-api-operator-integration` - Integration tests (if enabled)
- `pull-ci-machine-api-operator-e2e-*` - E2E test suites

**Post-submit tests (run on merge):**
- `branch-ci-machine-api-operator-unit` - Unit tests
- `branch-ci-machine-api-operator-e2e-*` - Full E2E suite
...
- [Development Guide](machine-api-operator_DEVELOPMENT.md) - Build and development workflow
