# machine-api-operator Ecosystem and References
...
This document provides links to related projects, upstream dependencies, documentation, and external resources relevant to machine-api-operator.
...
**Relationship:** machine-api-operator runs on Kubernetes
...
**Relationship:** machine-api-operator is part of OpenShift platform
...
Key libraries and frameworks used by machine-api-operator:
...
- [Development Guide](../machine-api-operator_DEVELOPMENT.md) - Build and develop
- [Testing Guide](../machine-api-operator_TESTING.md) - Test suites
